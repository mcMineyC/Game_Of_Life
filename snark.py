from regexes import RLE_to_matrix, easy_RLE_to_txt, txt_to_matrix
...
snarky = RLE_to_matrix(the_snark)

snark_txt = easy_RLE_to_txt(the_snark)
other_snark_loop = txt_to_matrix(snark_txt)
print(snark_txt)
print(snarky == other_snark_loop)